...
Socratium is a local-first reading companion that uses Socratic prompts and retrieval practice to make technical reading active. It runs entirely on your machine and currently supports OpenRouter via the backend.
...
AI settings live in a global modal accessible from the header. Providers: OpenRouter (model list available).
